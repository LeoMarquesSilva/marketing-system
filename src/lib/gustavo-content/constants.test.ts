...
beforeEach(() => {
  vi.resetModules();
  for (const name of ["GUSTAVO_CONTENT_MODEL", "GUSTAVO_CONTENT_MODEL_WRITING", "GUSTAVO_CONTENT_MODEL_WRITING_FALLBACK", "GUSTAVO_CONTENT_MODEL_SCORE", "GUSTAVO_CONTENT_MODEL_REVIEW"]) {

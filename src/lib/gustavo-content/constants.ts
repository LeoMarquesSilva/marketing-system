...
export const GUSTAVO_CONTENT_WRITING_TIMEOUT_MS = 120_000;
export const GUSTAVO_CONTENT_WRITING_FALLBACK_TIMEOUT_MS = 90_000;
export const GUSTAVO_CONTENT_GENERATION_TIMEOUT_MS = 270_000;

-- Achado ao rodar contra produção: dos 154 registros "unmatched" hoje em
-- hr_vios_employees, 100% são ex-colaboradores inativos (staging antiga,
-- nunca exibida em lugar nenhum). Criar ficha + notificar para esse backlog
-- inativo seria ruído puro. Restringe a criação automática de ficha mínima
-- (introduzida em 20260909130000) a CIs unmatched que o VIOS ainda marca
-- como ativos — só aí é de fato "colaborador novo" a completar.
